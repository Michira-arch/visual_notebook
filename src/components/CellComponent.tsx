...
import { ChevronLeft, ChevronRight, Plus, Wand2, Trash2, Edit3, Type, Zap, Code2 } from 'lucide-react';
...
export default function CellComponent({ cell, allCells, references, modelConfig, onUpdate, onRemove }: {
  ...
  if (cell.type === 'markdown') {
    return (
      <div className="relative border border-[var(--border)] bg-[var(--bg2)] rounded shadow-xl overflow-hidden mb-8 transition-all hover:border-[var(--green)]/50 group">
  ...
  return (
    <div className="relative border border-[var(--border)] bg-[var(--bg2)] rounded shadow-xl overflow-hidden mb-8 transition-all hover:border-[var(--cyan-dim)] group">
      <div className="flex items-center justify-between px-4 py-2 bg-[var(--bg2)] border-b border-[var(--border)]">
