...
export default function CodeCell({ id, codeContent, language, onUpdate, onRemove }: Props) {
  ...
  return (
    <div className="relative border border-[var(--border)] bg-[var(--bg2)] rounded shadow-xl overflow-hidden mb-8 transition-all hover:border-[var(--purple)]/50 group">
      {/* Header */}
